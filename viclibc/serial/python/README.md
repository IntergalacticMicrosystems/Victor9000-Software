...
- LENGTH: Little-endian, max 1024
- TYPE: bits 0-6: DATA=0x01, ACK=0x02, NAK=0x03; bit 7: alternating
  sequence bit on DATA/ACK (suppresses duplicate delivery after a lost ACK)
