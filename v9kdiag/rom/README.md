...
The font is generated by `genfont.py` into `font.inc` (ASCII-indexed, glyph
index = ASCII − 0x20). Regenerate with `python3 genfont.py` after editing glyphs.
...
| `genfont.py` | font generator (5×7 glyphs → Victor cell format) |
