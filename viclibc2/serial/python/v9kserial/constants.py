...
PKT_MAX_PAYLOAD = 2000  # Maximum payload size (matches PKT_MAX_PAYLOAD in
                        # serial/include/packet.h; must exceed the largest
                        # filetrx DATA packet: FTX_CHUNK_SIZE 1024 + 6-byte
                        # header = 1030)
